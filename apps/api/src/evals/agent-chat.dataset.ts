...
export const toolSelectionDataset: ToolSelectionTestCase[] = [
  ...
  },
  {
    ...
    expected: { tools: ["searchThreads", "setDraft"] },
  },
  {
    input: {
      userMessage: "Read through thread thread-similar-001 and summarize it",
      thread: THREAD_FIXTURES.passwordReset,
    },
  ...
  },
  {
    ...
    expected: { tools: ["searchDocumentation", "setDraft"] },
  },
  {
    input: {
...
- "Webhook delivery delays" (_id: thread-similar-001, by John Davis, similarity: 85%)`,
    },
    expected: {
...
The following suggestions have been automatically generated by our analysis system for this thread.
### Possible Duplicate
This thread may be a duplicate of "Login page blank after deployment" (_id: thread-dup-001), confidence: high. Reason: Both report blank login page after recent changes.`,
      toolOverrides: {
...
export const threadReferenceDataset: ThreadReferenceTestCase[] = [
  {
    ...
    expected: {
      threadIds: ["thread-similar-001", "thread-similar-002"],
      threadNames: [
  ...
  },
  {
    ...
    expected: {
      threadIds: ["thread-bug-001", "thread-bug-002"],
      threadNames: [
