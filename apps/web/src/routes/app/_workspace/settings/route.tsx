...
function RouteComponent() {
  return (
    <div className="w-screen h-full flex overflow-hidden">
      <SettingsSidebar />
      <Card className="flex-1 bg-muted/30 relative m-2 ml-0 h-auto p-4 [&:has([data-slot=sidebar-trigger])]:ml-2 [&:has([data-slot=sidebar-trigger])_[data-slot=card-header]]:pl-12">
