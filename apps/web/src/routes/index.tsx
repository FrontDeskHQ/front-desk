        ...
        <div className="w-full max-w-6xl grid grid-cols-12 mx-auto">
          ...
          >
            ...
            <div className="border-y min-h-48 flex flex-col px-4 py-6 gap-2 col-span-full md:col-span-1">
              ...
              <div className="text-muted-foreground">
                All your support channels in one place. No more switching
                between apps.
              </div>
            </div>
            <div className="border-y border-x min-h-48 flex flex-col px-4 py-6 gap-2 col-span-full md:col-span-1">
              ...
              <div className="text-muted-foreground">
                Realtime sync, no page loads, instant searches. FrontDesk
              ...
              <div className="col-span-full">
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent className="flex flex-col gap-4 text-balance">
                      <p>
                        ...
                        resolve becomes a resource that future customers can
                        find through search engines, reducing repetitive
                        questions and improving your SEO.
                      </p>
                      <p>
                        ...
                        realtime sync, instant feedback, zero page loads and
                        even offline support.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-3">
                    ...
                    <AccordionContent className="flex flex-col gap-4 text-balance">
                      ...
                      <p>
                        ...
                        Since a lot of times potential customers are searching
                        for answers before they even know you exist, having a
                        public support portal helps them discover your business
                        and feel confident that you care about your customers
                        needs.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-5">
                    ...
                    <AccordionContent className="flex flex-col gap-4 text-balance">
                      <p>
                        Absolutely! You can upgrade or downgrade your plan at
                        any time with no penalties or long-term commitments.
                        Changes take effect immediately, and we&apos;ll prorate
                      ...
                      <p>
                        ...
                        downgrade if your needs change, and all your data
                        remains intact.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
