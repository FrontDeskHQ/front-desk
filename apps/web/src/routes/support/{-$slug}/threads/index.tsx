  ...
  return (
    <div className="w-full">
      ...
      <div className=" mx-auto w-full px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center gap-6 rounded-lg p-6 shadow-sm border border-neutral-800">
          <Avatar
            variant="org"
            size="xxl"
        ...
        <div className="mb-6">
          <Input
            ...
            className="w-full border-neutral-800 text-neutral-50 placeholder:text-neutral-400"
          />
        </div>
