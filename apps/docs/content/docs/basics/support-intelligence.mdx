...
- **Inside a thread** — An inline panel with per-thread suggestions (labels, status, duplicates), a sidebar section showing related threads, and a AI assistant.
...
1. Go to **Organization Settings** → **Support Intelligence**
